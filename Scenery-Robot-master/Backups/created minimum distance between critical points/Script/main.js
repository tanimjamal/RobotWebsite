...
var middleEraseLeftCount, middleEraseRightCount;
    ...
    if (haveDimensions == true) {
      if (fullMouseHistoryPoints.length > 0) {
        ...
        if (editLocation == "middle") {
          console.log("yolo");
          console.log(preEditFullMouseHistoryPoints.length);
          console.log(preEditCritPointsList.length);
          ...
          //console.log(startLocation.contains(currentXPos, currentYPos));
  ...
  if (fullMouseHistoryPoints.length >= 2) {
    for (var i = 0; i < fullMouseHistoryPoints.length - 1; i++) {
      if (i == indexEdited && editLocation == "middle") {
        console.log("history", fullMouseHistoryPoints[i]);
        i = i + 1;
        console.log(
          "what middle right sould be ",
          fullMouseHistoryPoints.length - i
        );
        console.log("history", fullMouseHistoryPoints[i]);
      }
      context.beginPath(); // begin
  ...
  if (edit == false) {
    ...
    if (numPointsSelected == 2) {
      ...
      if (edit == false && editLocation == "clearPage") {
        preEditCritPointsList = criticalPointsList;
        preEditFullMouseHistoryPoints = fullMouseHistoryPoints;
      ...
      if (edit == false && editLocation == "middle") {
        ...
        console.log(middleEditOne, middleEditTwo);
        preEditCritPointsList = criticalPointsList;
        preEditFullMouseHistoryPoints = fullMouseHistoryPoints;
        /*
        console.log("start and end splice", startSplice, endSplice);
        console.log("length", fullMouseHistoryPoints.length);
        middleEraseLeftCount = Math.min(startSplice, endSplice);
        console.log(middleEraseLeftCount);
        middleEraseRightCount =
          fullMouseHistoryPoints.length - Math.max(startSplice, endSplice);
        console.log("middle erase right count", middleEraseRightCount);

        console.log(
          "comparing left two values",
          fullMouseHistoryPoints[middleEraseLeftCount],
          fullMouseHistoryPoints[Math.min(startSplice, endSplice)]
        );
        console.log(
          "comparing right two values",
          fullMouseHistoryPoints[
            fullMouseHistoryPoints.length - middleEraseRightCount
          ]
        );
          */
        fullMouseHistoryPoints.splice(
